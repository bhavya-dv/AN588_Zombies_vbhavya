...
#vbhavya: Yes, I actually did end up having to update my R, but it's still giving an error with the 'tidyr' package. I have no idea why, 
...
#vbhavya: thanks for the confirmation!
...
#vbhavya: I'm not sure if my approaches are correct. But I tried my best!
...
#vbhavya: I din't think they do. At least, when I tried it, it didn't work. 

set.seed(1)
y <- d$weight #change variable every time
x <- rnorm(1000, mean(y), stdev(y))
hist(x, probability = TRUE) #Making a histogram to check the distribution of the sample distribution. Because of CLT, it is expected to be normal
...
x <- rpois(1000, lambda = mean(y)) #Using rpois() instead of rnorm() because the zombies_killed data is a Poisson distribution, unlike age, weight and height.
hist(x, probability = TRUE)
...
I was really grateful for the suggestions about adding explanations. I think I was doing things because they felt right but being forced to express them really help with making it clearer as to why I might be doing a particular step. 